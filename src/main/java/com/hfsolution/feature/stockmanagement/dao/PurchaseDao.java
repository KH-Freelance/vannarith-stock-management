...
public class PurchaseDao extends BaseDBDao<Purchase,Long>{
  ...
  public BaseEntityResponseDto<Purchase>  findByPurchaseCode(String purchaseCode){
    ...
    try {
      ...
      Purchase entity = purchaseRepository.findByPurchaseCode(purchaseCode);
  ...
  public BaseEntityResponseDto<Purchase>  findByPurchaseCodes(List<String> purchaseCodes){
    ...
    try {
      ...
      List<Purchase> entities = purchaseRepository.findByPurchaseCodeIn(purchaseCodes);
      var appModel = new BaseEntityResponseDto<Purchase>();
      appModel.setStatus(SUCCESS);
  ...
  public BaseEntityResponseDto<Purchase> findPurchaseByUserId(long userId){
    ...
    try {
      ...
      List<Purchase> entity = purchaseRepository.findAllByUserId(userId);
      var appModel = new BaseEntityResponseDto<Purchase>();
      appModel.setStatus(SUCCESS);
      appModel.setEntityList(entity);
      appModel.setSummaryExecInfo(InfoGenerator.generateInfo(currentMethodName, startTime));
